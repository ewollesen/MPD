 ...
 */
static void
tag_id3_import_ufid_musicbrainz(struct id3_tag *id3_tag,
				const TagHandler &handler,
				void *handler_ctx)
{
	for (unsigned i = 0;; ++i) {
 ...
 */
static void
tag_id3_import_ufid_mildred(struct id3_tag *id3_tag,
                            const TagHandler &handler, void *handler_ctx)
{
	for (unsigned i = 0;; ++i) {
		const id3_frame *frame = id3_tag_findframe(id3_tag, "UFID", i);
...
tag_id3_import_ufid(struct id3_tag *id3_tag,
		    const TagHandler &handler, void *handler_ctx)
{
	tag_id3_import_ufid_musicbrainz(id3_tag, handler, handler_ctx);
	tag_id3_import_ufid_mildred(id3_tag, handler, handler_ctx);
}
